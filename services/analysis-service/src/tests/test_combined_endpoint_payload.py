...
class TestCombinedEndpointForwardsContent:
    def test_content_and_spans_reach_the_scanner(self):
        ...
        with mock_patch.object(main, "run_opengrep_with_limitations", fake_run_opengrep):
    ...
    def test_the_two_endpoints_agree_on_the_scanner_payload(self):
        ...
        with mock_patch.object(main, "run_opengrep_with_limitations", record(combined)):
            main.analyze_pull_request_payload(_request())
        with mock_patch.object(main, "run_opengrep_with_limitations", record(split)):
