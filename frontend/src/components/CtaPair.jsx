...
/*
 * The one call to action used across the marketing pages: start with GitHub (or
 * open the workspace when signed in) next to the sample review.
 */
const GitHubIcon = () => (
...
export default function CtaPair({ user, onLogin }) {
  return (
